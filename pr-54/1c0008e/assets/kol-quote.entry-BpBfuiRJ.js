import{c as e,r as t,s as n}from"./index-B7tv7olz-BQ36YrvG.js";import{d as r}from"./component-names-Dy77vq43-y0h3WhLS.js";import{o as i}from"./index-3KsxeWE1.js";import"./isArray-CcrBs4JM-Bl_U_CM4.js";import"./_Uint8Array-kJHDjtoP-C7gl70Rp.js";import{n as a,o}from"./normalizers-DnkJhVYZ-kQo-6XOg.js";import{r as s,t as c}from"./variant-quote-CHD0qMkY-Bmxp221_.js";import{t as l}from"./label-BEOW9ltS-CjwJjpvM.js";import{t as u}from"./base-controller-CXhqh4cR-DNOqRYhI.js";var d=a(`href`,``,o,e=>typeof e==`string`),f=a(`quote`,``,o),p=i.forBlock(`kol-quote`),m=p(`blockquote`),h=p(`cite`),g=p(`figcaption`),_=p(`quote`),v=e=>{let{href:t,label:i,quote:a,variant:o}=e,s=a===``;return n(`figure`,{class:p({[o]:!0})},o===`block`?n(`blockquote`,{class:m,cite:t},a,n(`span`,{"aria-hidden":s?void 0:`true`,hidden:!s},n(`slot`,{name:`expert`}))):n(`q`,{class:_,cite:t},a,n(`span`,{"aria-hidden":s?void 0:`true`,hidden:!s},n(`slot`,{name:`expert`}))),typeof i==`string`&&i.length>0&&n(`figcaption`,{class:g},n(`cite`,{class:h},n(r,{_href:t,_label:i,_target:`_blank`}))))},y={optional:[l,s],required:[d,f]},b=class extends u{constructor(e){super(e,y)}componentWillLoad(e){let{href:t,label:n,quote:r,variant:i}=e;this.watchHref(t),this.watchLabel(n),this.watchQuote(r),this.watchVariant(i)}watchHref(e){d.apply(e,e=>{this.setRenderProp(`href`,e)})}watchLabel(e){l.apply(e,e=>{this.setRenderProp(`label`,e)})}watchQuote(e){f.apply(e,e=>{this.setRenderProp(`quote`,e)})}watchVariant(e){s.apply(e,e=>{this.setRenderProp(`variant`,e)})}},x=`@charset "UTF-8";
