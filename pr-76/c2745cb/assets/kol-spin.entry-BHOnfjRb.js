import"./i18n-CoO4-0na-qoovQgD0.js";import{c as e,n as t,r as n,s as r}from"./index-CJ6nR8sE-ClsZv9fX.js";import{t as i}from"./base-web-component-BT6jbe_v-SPsPlDfK.js";import"./isArray-CcrBs4JM-WIW03eH5.js";import"./_Uint8Array-kJHDjtoP-B3BfDOx1.js";import{n as a,o,r as s}from"./normalizers-Dmgd1cXp-D9fQTtfI.js";import{t as c}from"./i18n-BsXYYo8j-CZqKME2o.js";import{t as l}from"./label-RX8TPr4R-DLg2iYje.js";import"./variant-quote-BI3zVSZn-3-MmVuKj.js";import{t as u}from"./base-controller-CXhqh4cR-DMPubRA9.js";var d=a(`show`,!1,s),f=[`dot`,`cycle`,`none`],p=a(`variant`,`dot`,e=>{let t=o(e);if(f.includes(t))return t;throw Error(`Invalid spin variant: ${t}`)},()=>!0);function m(e){switch(e){case`cycle`:return r(`span`,{class:`kol-spin__loader kol-spin__spinner--${e}__element`});case`none`:return r(`slot`,{name:`expert`});default:return r(t,null,r(`span`,{class:`kol-spin__spinner-element 
							...
							kol-spin__spinner--${e}__element 
							kol-spin__spinner--${e}__element--4`}))}}var h=e=>{let{show:n,label:i,variant:a,showToggled:o}=e;return r(t,null,n?r(t,null,r(`span`,{class:`kol-spin__spinner kol-spin__spinner--${a}`},m(a)),r(`span`,{"aria-busy":`true`,class:`visually-hidden`,role:`alert`},i||c(`kol-action-running`))):o&&r(`span`,{"aria-busy":`false`,class:`visually-hidden`,role:`alert`},i||c(`kol-action-done`)))},g={optional:[l,d,p]},_=class extends u{constructor(e){super(e,g)}componentWillLoad(e){let{show:t,label:n,variant:r}=e;this.watchShow(t),this.watchLabel(n),this.watchVariant(r)}watchShow(e){d.apply(e,e=>{let t=this.getRenderProp(`show`);this.setRenderProp(`show`,e),this.setState(`showToggled`,t===!0&&e===!1)})}watchLabel(e){l.apply(e,e=>{this.setRenderProp(`label`,e)})}watchVariant(e){p.apply(e,e=>{this.setRenderProp(`variant`,e)})}},v=`@charset "UTF-8";
