import"./i18n-CoO4-0na-qoovQgD0.js";import{c as e,f as t,l as n,p as r}from"./index-Bzsf6a1p.js";import{t as i}from"./base-web-component-BT6jbe_v-DWHCzOf8.js";import"./isArray-CcrBs4JM-C7XdtgJ2.js";import"./_Uint8Array-kJHDjtoP-Cgd-xGMS.js";import{n as a,o,r as s}from"./normalizers-Dmgd1cXp-D14ncJWd.js";import{t as c}from"./i18n-BsXYYo8j-pJ08HAmu.js";import{t as l}from"./label-RX8TPr4R-BpzALKBH.js";import"./variant-quote-BI3zVSZn-B8h_1DnW.js";import{t as u}from"./base-controller-CXhqh4cR-KCGhnJij.js";var d=a(`show`,!1,s),f=[`dot`,`cycle`,`none`],p=a(`variant`,`dot`,e=>{let t=o(e);if(f.includes(t))return t;throw Error(`Invalid spin variant: ${t}`)},()=>!0);function m(n){switch(n){case`cycle`:return t(`span`,{class:`kol-spin__loader kol-spin__spinner--${n}__element`});case`none`:return t(`slot`,{name:`expert`});default:return t(e,null,t(`span`,{class:`kol-spin__spinner-element 
