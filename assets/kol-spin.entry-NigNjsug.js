import"./i18n-B2d_exHc-Danqu8G9.js";import{c as e,f as t,l as n,p as r}from"./index-ClDpkwS6.js";import"./isArray-CcrBs4JM-BA9_Jb9Z.js";import"./_Uint8Array-kJHDjtoP-DNO7XOnd.js";import{n as i,o as a,r as o}from"./normalizers-m3s9sgmq-DIISDBGJ.js";import{t as s}from"./variant-quote-y0Z1TRdz-Do5rXicR.js";import{t as c}from"./label-KTv-zMW0-BniijOup.js";import{t as l}from"./base-controller-CXhqh4cR-ht1hwgla.js";import{t as u}from"./i18n-Br16IAnY-c30wEQqy.js";var d=i(`show`,!1,o),f=[`dot`,`cycle`,`none`],p=i(`variant`,`dot`,e=>{let t=a(e);if(f.includes(t))return t;throw Error(`Invalid spin variant: ${t}`)},()=>!0);function m(n){switch(n){case`cycle`:return t(`span`,{class:`kol-spin__loader kol-spin__spinner--${n}__element`});case`none`:return t(`slot`,{name:`expert`});default:return t(e,null,t(`span`,{class:`kol-spin__spinner-element 
							...
							kol-spin__spinner--${n}__element 
							kol-spin__spinner--${n}__element--4`}))}}var h=n=>{let{show:r,label:i,variant:a,showToggled:o,handleGetTranslateActionRunning:s,handleGetTranslateActionDone:c}=n;return t(e,null,r?t(e,null,t(`span`,{class:`kol-spin__spinner kol-spin__spinner--${a}`},m(a)),t(`span`,{"aria-busy":`true`,class:`visually-hidden`,role:`alert`},i||s())):o&&t(`span`,{"aria-busy":`false`,class:`visually-hidden`,role:`alert`},i||c()))},g={optional:[c,d,p]},_=class extends l{constructor(e){super(e,g),this.translateActionRunning=u(`kol-action-running`),this.translateActionDone=u(`kol-action-done`),this.handleGetTranslateActionRunning=()=>this.translateActionRunning,this.handleGetTranslateActionDone=()=>this.translateActionDone}componentWillLoad(e){let{show:t,label:n,variant:r}=e;this.watchShow(t),this.watchLabel(n),this.watchVariant(r)}watchShow(e){d.apply(e,e=>{let t=this.getRenderProp(`show`);this.setRenderProp(`show`,e),this.setState(`showToggled`,t===!0&&e===!1)})}watchLabel(e){c.apply(e,e=>{this.setRenderProp(`label`,e)})}watchVariant(e){p.apply(e,e=>{this.setRenderProp(`variant`,e)})}},v=`/* forward the rem function */
/*
