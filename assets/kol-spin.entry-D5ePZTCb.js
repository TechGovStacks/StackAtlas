import"./i18n-B2d_exHc-CgGRpl2S.js";import{c as e,d as t,f as n,s as r}from"./index-CUmjwtrG.js";import"./isArray-CcrBs4JM-BA9_Jb9Z.js";import"./_Uint8Array-kJHDjtoP-BG0C2avY.js";import{n as i,o as a,r as o}from"./normalizers-DnkJhVYZ-BfazJdTD.js";import{t as s}from"./variant-quote-CHD0qMkY-BO2NkeUW.js";import{t as c}from"./label-BEOW9ltS-CBlQC0wR.js";import{t as l}from"./base-controller-CXhqh4cR-ht1hwgla.js";import{t as u}from"./i18n-BVaUp6qp-v2CjLMjP.js";var d=i(`show`,!1,o),f=[`dot`,`cycle`,`none`],p=i(`variant`,`dot`,e=>{let t=a(e);if(f.includes(t))return t;throw Error(`Invalid spin variant: ${t}`)},()=>!0);function m(e){switch(e){case`cycle`:return t(`span`,{class:`kol-spin__loader kol-spin__spinner--${e}__element`});case`none`:return t(`slot`,{name:`expert`});default:return t(r,null,t(`span`,{class:`kol-spin__spinner-element \n\t\t\t\t\t\t\tkol-spin__spinner-element--1 \n\t\t\t\t\t\t\tkol-spin__spinner--${e}__element \n\t\t\t\t\t\t\tkol-spin__spinner--${e}__element--1`}),t(`span`,{class:`kol-spin__spinner-element \n\t\t\t\t\t\t\tkol-spin__spinner-element--2 \n\t\t\t\t\t\t\tkol-spin__spinner--${e}__element \n\t\t\t\t\t\t\tkol-spin__spinner--${e}__element--2`}),t(`span`,{class:`kol-spin__spinner-element \n\t\t\t\t\t\t\tkol-spin__spinner-element--3 \n\t\t\t\t\t\t\tkol-spin__spinner--${e}__element \n\t\t\t\t\t\t\tkol-spin__spinner--${e}__element--3`}),t(`span`,{class:`kol-spin__spinner-element \n\t\t\t\t\t\t\tkol-spin__spinner-element--neutral \n\t\t\t\t\t\t\tkol-spin__spinner--${e}__element \n\t\t\t\t\t\t\tkol-spin__spinner--${e}__element--4`}))}}var h=e=>{let{show:n,label:i,variant:a,showToggled:o,handleGetTranslateActionRunning:s,handleGetTranslateActionDone:c}=e;return t(r,null,n?t(r,null,t(`span`,{class:`kol-spin__spinner kol-spin__spinner--${a}`},m(a)),t(`span`,{"aria-busy":`true`,class:`visually-hidden`,role:`alert`},i||s())):o&&t(`span`,{"aria-busy":`false`,class:`visually-hidden`,role:`alert`},i||c()))},g={optional:[c,d,p]},_=class extends l{constructor(e){super(e,g),this.translateActionRunning=u(`kol-action-running`),this.translateActionDone=u(`kol-action-done`),this.handleGetTranslateActionRunning=()=>this.translateActionRunning,this.handleGetTranslateActionDone=()=>this.translateActionDone}componentWillLoad(e){let{show:t,label:n,variant:r}=e;this.watchShow(t),this.watchLabel(n),this.watchVariant(r)}watchShow(e){d.apply(e,e=>{let t=this.getRenderProp(`show`);this.setRenderProp(`show`,e),this.setState(`showToggled`,!0===t&&!1===e)})}watchLabel(e){c.apply(e,e=>{this.setRenderProp(`label`,e)})}watchVariant(e){p.apply(e,e=>{this.setRenderProp(`variant`,e)})}},v=`/* forward the rem function */
/*
