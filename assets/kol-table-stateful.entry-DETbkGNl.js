import"./i18n-B2d_exHc-BfE6g6It.js";import{_ as e,p as t}from"./component-names-Dy77vq43-y0h3WhLS.js";import{$ as n,A as r,M as i,Z as a,d as o,f as s,l as c,mt as l,ot as u,p as d,ut as f,v as p,y as m}from"./index-BsTrHCQU.js";import{r as h}from"./label-vxVEH2gH-NEikb69C.js";import{t as g}from"./i18n-BVaUp6qp-CGAqz332.js";import{a as _,i as v,n as y,o as b,s as x,t as S}from"./table-selection-CXJmsMfX-BE4i-_e2.js";import{t as C}from"./keyboard-DNd73LVa-CbqXZTcs.js";var w=(e,t,n={})=>{f(e,`_allowMultiSort`,t,Object.assign({defaultValue:!1},n))},T=[`top`,`bottom`,`both`],E=(e,t)=>{l(e,`_paginationPosition`,e=>typeof e==`string`&&T.includes(e),new Set([`PaginationPositionPropType {${T.join(`, `)}`]),t,{defaultValue:`bottom`})},D=`@charset "UTF-8";
/*
...
}`,O=[10,20,50,100],k=e=>!0===e||e===``||typeof e==`object`&&!!e,A=class{constructor(e){d(this,e),this.catchRef=e=>{this.tableWcRef=e},this.sortData=[],this.showPagination=!1,this.pageStartSlice=0,this.pageEndSlice=10,this.disableSort=!1,this._paginationPosition=`bottom`,this.state={_allowMultiSort:!1,_fixedCols:[0,0],_data:[],_dataFoot:[],_headers:{horizontal:[],vertical:[]},_label:``,_pagination:{_page:1,_pageSize:10,_max:0},_sortedData:[],_paginationPosition:`bottom`,_hasSettingsMenu:!1},this.handlePagination={onClick:(e,t)=>{typeof this.state._pagination._on?.onClick==`function`&&this.state._pagination._on.onClick(e,t),u(this,`_pagination`,Object.assign(Object.assign({},this.state._pagination),{_page:t}))},onChangePage:(e,t)=>{typeof this.state._pagination._on?.onChangePage==`function`&&this.state._pagination._on.onChangePage(e,t),u(this,`_pagination`,Object.assign(Object.assign({},this.state._pagination),{_page:t}))},onChangePageSize:(e,t)=>{typeof this.state._pagination._on?.onChangePageSize==`function`&&this.state._pagination._on.onChangePageSize(e,t),u(this,`_pagination`,Object.assign(Object.assign({},this.state._pagination),{_pageSize:t})),u(this,`_pageSize`,t)}},this.onSelectionChange=e=>{e.stopPropagation()},this.updateSortedData=()=>{if(this.disableSort)return void u(this,`_sortedData`,this.state._data);let e=[...this.state._data];this.sortData.length>0&&e.sort((e,t)=>{for(let n=0;n<this.sortData.length;n++){let r=this.sortData[n],i=r.compareFn(e,t,r.direction);if(i!==0)return r.direction===`ASC`?i:-i}return 0}),u(this,`_sortedData`,e)}}validateAllowMultiSort(e){w(this,e,{defaultValue:!1})}validateData(e){v(this,e,{afterPatch:()=>{setTimeout(this.updateSortedData)}})}validateDataFoot(e){_(this,e,{afterPatch:()=>{setTimeout(this.updateSortedData)}})}validateFixedCols(e){S(this,e)}validatePaginationPosition(e){E(this,e)}validateHasSettingsMenu(e){y(this,e)}changeCellSort(e){if(e.type===void 0||e.type===`default`){if(typeof e.compareFn!=`function`)return;this.state._allowMultiSort||e.key===this.sortData[0]?.key||(this.sortData=[]);let t=this.sortData.findIndex(t=>t.key===e.key);if(t>=0){let e=this.sortData[t];switch(e.direction){case`ASC`:e.direction=`DESC`;break;case`DESC`:this.sortData.splice(t,1);break;default:e.direction=`ASC`}}else e.key&&this.sortData.push({label:e.label,key:e.key,compareFn:e.compareFn,direction:`ASC`});this.updateSortedData()}}initializeSortFromHeaders(e){var t,n;let i=!1,a=e=>{this.sortData=[],e.forEach(e=>{if(e.type!==void 0&&e.type!==`default`)return;if(typeof e.compareFn==`function`&&!e.key)return void r(`[KolTableStateful] A sortable column requires the 'key' property.`);let t=e.key;if(!t)return;let n=e.sortDirection;n!==`ASC`&&n!==`DESC`||typeof e.compareFn==`function`&&((this.state._allowMultiSort||this.sortData.length===0)&&this.sortData.push({label:e.label,key:t,compareFn:e.compareFn,direction:n}),i=!0)})};return(t=e.horizontal)==null||t.forEach(a),(n=e.vertical)==null||n.forEach(a),i}validateHeaders(e){i(e,()=>{a(e,()=>{try{e=n(e)}catch{}l(this,`_headers`,e=>typeof e==`object`&&!!e,new Set([`KoliBriTableHeaders`]),e,{hooks:{beforePatch:e=>{let t=e;this.initializeSortFromHeaders(t)&&setTimeout(()=>this.updateSortedData()),t.horizontal&&t.vertical&&t.horizontal?.length>0&&t.vertical?.length>0&&(this.disableSort=!0,r(`Table: You can not sort the table data, if horizontal and vertical headers are defined at the same time. (https://github.com/public-ui/kolibri/issues/2372)`))}}})})})}validateLabel(e){h(this,e,{required:!0})}validateSelection(e){b(this,e)}validateOn(e){x(this,e)}validatePagination(e){try{e=n(e)}catch{}this.showPagination=k(e),l(this,`_pagination`,k,new Set([`boolean`,`KoliBriTablePagination`]),e,{defaultValue:{_page:1,_pageSize:10,_max:0}})}componentDidLoad(){var e;(e=this.tableWcRef)==null||e.addEventListener(p.selectionChange,this.onSelectionChange)}disconnectedCallback(){var e;(e=this.tableWcRef)==null||e.removeEventListener(p.selectionChange,this.onSelectionChange)}componentWillLoad(){this.validateAllowMultiSort(this._allowMultiSort),this.validateData(this._data),this.validateDataFoot(this._dataFoot),this.validateFixedCols(this._fixedCols),this.validateHeaders(this._headers),this.validateLabel(this._label),this.validateOn(this._on),this.validatePagination(this._pagination),this.validatePaginationPosition(this._paginationPosition),this.validateSelection(this._selection),this.validateHasSettingsMenu(this._hasSettingsMenu)}selectDisplayedData(e,t,n){return typeof t==`number`&&t>0&&typeof n==`number`&&n>0?(this.pageStartSlice=t*(n-1),this.pageEndSlice=t*n>e.length?e.length:t*n,e.slice(this.pageStartSlice,this.pageEndSlice)):(this.pageStartSlice=0,this.pageEndSlice=e.length,e)}renderPagination(e){let n=g(`kol-table-pagination-label`,{placeholders:{label:`${this.state._label} (${g(`kol-pagination-position-${e}`)})`}});return s(`div`,{class:`kol-table-stateful__pagination kol-table-stateful__pagination--${this.state._paginationPosition}`},s(`div`,{class:`kol-table-stateful__pagination-wrapper`},s(t,{_boundaryCount:this.state._pagination._boundaryCount,_customClass:this.state._pagination._customClass,_hasButtons:this.state._pagination._hasButtons,_on:this.handlePagination,_page:this.state._pagination._page,_pageSize:this.state._pagination._pageSize,_pageSizeOptions:this.state._pagination._pageSizeOptions||O,_siblingCount:this.state._pagination._siblingCount,_tooltipAlign:`bottom`,_max:this.state._pagination._max||this.state._pagination._max||this.state._data.length,_label:n})))}getHeaderCellSortState(e){if((e.type===void 0||e.type===`default`)&&!this.disableSort&&typeof e.compareFn==`function`){if(e.key){let t=this.sortData.find(t=>t.key===e.key);if(t?.direction)return t.direction}return`NOS`}}getHeaderCellSortOrder(e){if((e.type===void 0||e.type===`default`)&&!this.disableSort&&this.state._allowMultiSort&&typeof e.compareFn==`function`&&e.key){let t=this.sortData.findIndex(t=>t.key===e.key);if(t>=0)return t+1}}handleSort({key:e}){let t=[...(this.state._headers.horizontal||[]).flat(),...(this.state._headers.vertical||[]).flat()].find(t=>t.key===e);t&&this.changeCellSort(t)}getSelectedData(e){let t=this.state._selection;if(t){let n=t.keyPropertyName??`id`,r=new Set(e.map(String)),i=this.state._sortedData.filter(e=>r.has(String(e[n])));if(n)return i}return null}handleSelectionChange(e,t){let n=this.state._selection;n&&(this.state=Object.assign(Object.assign({},this.state),{_selection:Object.assign(Object.assign({},n),{selectedKeys:t})}));let r=this.getSelectedData(t);typeof this.state._on?.[C.onSelectionChange]==`function`&&this.state._on[C.onSelectionChange](e,r),this.host&&m(this.host,p.selectionChange,r)}async getSelection(){let e=this.state._selection?.selectedKeys||[];return this.getSelectedData(e)}async resetSort(){this.initializeSortFromHeaders(this.state._headers),this.updateSortedData()}render(){let t=this.selectDisplayedData(this.state._sortedData,this.showPagination?this.state._pagination?._pageSize??10:this.state._sortedData.length,this.state._pagination._page||1),n=this._paginationPosition===`top`||this._paginationPosition===`both`?this.renderPagination(`top`):null,r=this._paginationPosition===`bottom`||this._paginationPosition===`both`?this.renderPagination(`bottom`):null,i={horizontal:this.state._headers.horizontal?.map(e=>e.map(e=>Object.assign(Object.assign({},e),{sortDirection:this.getHeaderCellSortState(e),sortOrder:this.getHeaderCellSortOrder(e)})))??[],vertical:this.state._headers.vertical?.map(e=>e.map(e=>Object.assign(Object.assign({},e),{sortDirection:this.getHeaderCellSortState(e),sortOrder:this.getHeaderCellSortOrder(e)})))??[]};return s(c,{key:`d542e368de34a849b5b64d17fd9696c3b95bc6c6`,class:`kol-table-stateful`},this.pageEndSlice>0&&this.showPagination&&n,s(e,{key:`22e7dcffb78183de0453ca1835cc8803114aed89`,ref:this.catchRef,_data:t,_fixedCols:this._fixedCols,_headerCells:i,_label:this.state._label,_dataFoot:this.state._dataFoot,_on:{onSort:(e,t)=>{this.handleSort(t)},onSelectionChange:(e,t)=>{this.handleSelectionChange(e,t)}},_selection:this.state._selection,_hasSettingsMenu:this.state._hasSettingsMenu}),this.pageEndSlice>0&&this.showPagination&&r)}get host(){return o(this)}static get watchers(){return{_allowMultiSort:[`validateAllowMultiSort`],_data:[`validateData`],_dataFoot:[`validateDataFoot`],_fixedCols:[`validateFixedCols`],_paginationPosition:[`validatePaginationPosition`],_hasSettingsMenu:[`validateHasSettingsMenu`],_headers:[`validateHeaders`],_label:[`validateLabel`],_selection:[`validateSelection`],_on:[`validateOn`],_pagination:[`validatePagination`]}}};A.style={default:D};export{A as kol_table_stateful};