import"./component-names-Dy77vq43-Btxnasjz.js";import"./i18n-B2d_exHc-CgGRpl2S.js";import{H as e,d as t,f as n,mt as r,ot as i,p as a,ut as o}from"./index-6aC4Ox-U.js";import{n as s}from"./dev.utils-B-ZwZYpj-TVWy2v5I.js";import"./isArray-CcrBs4JM-BA9_Jb9Z.js";import"./_Uint8Array-kJHDjtoP-BG0C2avY.js";import"./normalizers-C14RETgU-xVLvs5JV.js";import"./variant-quote-DI6q8gPw-CsSS_N_c.js";import{t as c}from"./tslib.es6-CxX45GIN-D5sRa3n3.js";import{t as l}from"./clsx-COFh-Vc8-BHwl83Bk.js";import{t as u}from"./component-BoywdBMh-BNRqSMYK.js";import"./component-FodZSQiD-g_qcFYsS.js";import"./component-CsqhVtuq-NWZU5Hku.js";import"./align-floating-elements-58sFZOrL-CesPmPr-.js";import"./align-D3Z54kEL-D-sPWNjQ.js";import"./label-DK7sT-k5-CeYYzpi2.js";import"./base-controller-CXhqh4cR-ht1hwgla.js";import"./controller-Cf3CGZT--VzHy-gy1.js";import"./label-vxVEH2gH-JUn5GzsT.js";import"./Heading-bieqYtyt-CC8Dl56m.js";import"./disabled-BBn2JEzf-apjxdCWH.js";import{n as d,t as f}from"./element-focus-BKUtVrWY-CkpEZQyF.js";import{n as p,t as m}from"./element-click-BTxuJDNT-h-jNCM0A.js";import"./i18n-BVaUp6qp-CB7rsDwh.js";import"./Alert-CSsB7kOG-7JwH6eYZ.js";import"./access-and-short-key-D2TiPdWw-moKVRvcJ.js";import"./hide-label-DQL9J6E_-CJohv3m7.js";import"./tooltip-align-DnbCY1Uu-DAJapXJo.js";import{n as h}from"./controller-eUfCqvxN-Cq9LdgiF.js";import"./associated.controller-BKQIR17--CJXwxRft.js";import{c as g,o as _,s as v,t as y}from"./FormFieldStateWrapper-I4Dg2nCz-DGDklDbO.js";import{t as b}from"./Input-DAPjMSh6-C48dbtSM.js";import"./required-C9Xj8kw2-C6tdIQWo.js";import"./orientation-D3LRVMo1-BqiJUGPW.js";import{t as x}from"./controller-BO62SDz4-BD2RlG7L.js";import{t as S}from"./FieldControlStateWrapper-bKthnrzB-BCSHpFzZ.js";var C=(e,t)=>{o(e,`_checked`,t)},w=(e,t)=>{o(e,`_indeterminate`,t)},T=[`left`,`right`],E=(e,t)=>{r(e,`_labelAlign`,e=>typeof e==`string`&&T.includes(e),new Set([`KoliBriLabelAlign {${T.join(`, `)}`]),t)},D=[`button`,`default`,`switch`],O=e=>typeof e==`string`&&D.includes(e),k=(e,t)=>{r(e,`_variant`,O,new Set(D),t)},A=class extends x{constructor(e,t,n){super(e,t,n),this.setFormAssociatedCheckboxValue=e=>{this.component._checked?this.setFormAssociatedValue(e):this.setFormAssociatedValue(null)},this.component=e}validateChecked(e){C(this.component,e),this.setFormAssociatedCheckboxValue(this.component.state._value)}validateIcons(t){r(this.component,`_icons`,t=>{let n=t;return typeof n==`object`&&!!n&&(e(n.checked,1)||e(n.indeterminate,1)||e(n.unchecked,1))},new Set([`InputCheckboxIcons`]),t,{hooks:{beforePatch:(e,t,n)=>{t.set(`_icons`,Object.assign(Object.assign({},n.state._icons),e))}}})}validateIndeterminate(e){w(this.component,e)}validateLabelAlign(e){E(this.component,e)}validateValue(e){i(this.component,`_value`,e),this.setFormAssociatedCheckboxValue(this.component.state._value)}validateVariant(e){k(this.component,e)}componentWillLoad(){super.componentWillLoad(),this.validateChecked(this.component._checked),this.validateIcons(this.component._icons),this.validateIndeterminate(this.component._indeterminate),this.validateValue(this.component._value),this.validateVariant(this.component._variant),this.validateLabelAlign(this.component._labelAlign)}},j=e=>{var{class:t,variant:r=`default`,icon:i,inputProps:a}=e,o=c(e,[`class`,`variant`,`icon`,`inputProps`]);let{class:s}=a,d=c(a,[`class`]),f={[`kol-checkbox--variant-${r}`]:!0,"kol-checkbox--checked":a?.checked,"kol-checkbox--indeterminate":a?.indeterminate,"kol-checkbox--disabled":!!a?.disabled,"kol-checkbox--required":!!a?.required,"kol-checkbox--touched":!!a?.touched,[`kol-checkbox--${_(a?.msg)}`]:!!g(a?.msg,a?.touched)};return n(`label`,Object.assign({class:l(`kol-checkbox`,f,t)},o),n(u,{label:``,icons:i,class:l(`kol-checkbox__icon`)}),n(b,Object.assign({class:l(`kol-checkbox__input`,s)},d,{type:`checkbox`})))};function M(e,t={}){let{ariaDescribedBy:n}=v(e),r={id:e._id,hideLabel:e._hideLabel,label:e._label,value:e._value,accessKey:e._accessKey,disabled:e._disabled,name:e._name,ariaDescribedBy:n};return`_required`in e&&(r.required=e._required),`_checked`in e&&(r.checked=e._checked),`_indeterminate`in e&&(r.indeterminate=e._indeterminate),`_touched`in e&&(r.touched=e._touched),`_msg`in e&&(r.msg=e._msg),`_shortKey`in e&&(r[`aria-keyshortcuts`]=e._shortKey),Object.assign(Object.assign({},r),t)}var N=e=>{var{state:t,inputProps:r}=e,i=c(e,[`state`,`inputProps`]);let a=t?._variant||`default`;return n(j,Object.assign({variant:a,inputProps:M(t,r)},i))},P=`@charset "UTF-8";
/*
