import"./i18n-B2d_exHc-CgGRpl2S.js";import{c as e,d as t,f as n}from"./index-B070G2cQ.js";import"./isArray-CcrBs4JM-BA9_Jb9Z.js";import"./_Uint8Array-kJHDjtoP-BG0C2avY.js";import{a as r,n as i,o as a}from"./normalizers-DnkJhVYZ-D6ytQBzb.js";import{t as o}from"./variant-quote-CHD0qMkY-vEaOlTP3.js";import{t as s}from"./label-BEOW9ltS-BeS_HocV.js";import{t as c}from"./base-controller-CXhqh4cR-ht1hwgla.js";import{t as l}from"./i18n-BVaUp6qp-DHUz87im.js";import{n as u,t as d}from"./unit-eRQuaHYy-CsacQlzu.js";var f=i(`high`,0,r),p=i(`low`,0,r),m=i(`min`,0,r),h=i(`optimum`,0,r),g=[`horizontal`,`vertical`],_=i(`orientation`,`horizontal`,e=>{let t=a(e);if(g.includes(t))return t;throw Error(`Invalid orientation: ${t}`)}),v=i(`value`,0,r,e=>e>=0);function y(e,t,n,r,i,a){let o=r??t,s=i??n;if(a===void 0)return e>=o&&e<=s?`optimum`:`suboptimal`;let c=e<o,l=e>s,u=!c&&!l;return a<o?c?`optimum`:u?`suboptimal`:`critical`:a>s?l?`optimum`:u?`suboptimal`:`critical`:u?`optimum`:`suboptimal`}var b=e=>{let{high:n,label:r,low:i,liveValue:a,max:o,min:s,optimum:c,orientation:u,unit:d,value:f}=e,p=u===`vertical`,m=d===`%`,h=m?Math.round((f-s)/(o-s)*100):f,g=m?`${Math.round((a-s)/(o-s)*100)}`:a,_=`${`${(m?100:o)+1}`.length}ch`,v=Math.min(100,Math.max(0,(f-s)/(o-s)*100)),b=y(f,s,o,i,n,c),x=i!==void 0||n!==void 0,S=x?l(`kol-meter-state-${b}`):``,C=m?l(`kol-live-value`,{placeholders:{value:String(g),unit:d}}):l(`kol-live-value-bounded`,{placeholders:{value:String(g),max:String(o),unit:d}}),w=x?`${C} – ${S}`:C,T={"kol-meter__bar-fill":!0,"kol-meter__bar-fill--optimum":b===`optimum`,"kol-meter__bar-fill--suboptimal":b===`suboptimal`,"kol-meter__bar-fill--critical":b===`critical`};return t(`div`,{class:{"kol-meter":!0,"kol-meter--vertical":p}},t(`div`,{"aria-hidden":`true`,class:`kol-meter__bar`},t(`div`,{class:`kol-meter__bar-label`},r,x&&t(`span`,{class:`kol-meter__bar-state kol-meter__bar-state--${b}`},` – `,S)),p?t(`div`,{class:`kol-meter__bar-track`},t(`div`,{class:T,style:{height:`calc((100% - 6px) * ${v/100})`}})):t(`svg`,{xmlns:`http://www.w3.org/2000/svg`,width:`100%`,height:`12`,overflow:`visible`},t(`rect`,{class:`kol-meter__bar-background`,x:`1`,y:`1`,height:`11`,rx:`5`,fill:`currentColor`,stroke:`currentColor`,"stroke-width":`3`,width:`100%`}),t(`rect`,{class:`kol-meter__bar-border`,x:`1`,y:`1`,height:`11`,rx:`5`,fill:`currentColor`,stroke:`currentColor`,"stroke-width":`1`,width:`100%`}),t(`rect`,{class:T,x:`3`,y:`3`,height:`7`,rx:`3.5`,fill:`currentColor`,stroke:`currentColor`,"stroke-width":`3`,style:{width:`calc(${v}% - 4px)`}})),t(`span`,{class:`kol-meter__value-unit`},t(`span`,{class:`kol-meter__value`,style:p?{}:{width:_}},h),`\xA0`,t(`span`,{class:`kol-meter__unit`},d))),t(`meter`,{"aria-label":r,class:`visually-hidden`,high:n,low:i,max:o,min:s,optimum:c,value:f}),t(`span`,{"aria-live":`polite`,"aria-relevant":`additions text`,class:`visually-hidden`},w))},x={optional:[m,_,u],required:[s,d,v]},S=class extends c{constructor(e){super(e,x),this.meterData={high:void 0,low:void 0,optimum:void 0}}componentWillLoad(e){let{high:t,label:n,low:r,max:i,min:a,optimum:o,orientation:s,unit:c,value:l}=e;this.watchHigh(t),this.watchLabel(n),this.watchLow(r),this.watchMax(i),this.watchMin(a),this.watchOptimum(o),this.watchOrientation(s),this.watchUnit(c),this.watchValue(l),this.setState(`liveValue`,this.getRenderProp(`value`)),this.startLiveValueInterval()}destroy(){this.interval&&=(clearInterval(this.interval),void 0)}getMeterData(){return this.meterData}watchHigh(e){e===void 0?this.meterData.high=void 0:f.apply(e,e=>{this.meterData.high=e})}watchLabel(e){s.apply(e,e=>{this.setRenderProp(`label`,e)})}watchLow(e){e===void 0?this.meterData.low=void 0:p.apply(e,e=>{this.meterData.low=e})}watchMax(e){d.apply(e,e=>{this.setRenderProp(`max`,e)})}watchMin(e){m.apply(e,e=>{this.setRenderProp(`min`,e)})}watchOptimum(e){e===void 0?this.meterData.optimum=void 0:h.apply(e,e=>{this.meterData.optimum=e})}watchOrientation(e){_.apply(e,e=>{this.setRenderProp(`orientation`,e)})}watchUnit(e){u.apply(e,e=>{this.setRenderProp(`unit`,e)})}watchValue(e){v.apply(e,e=>{this.setRenderProp(`value`,e)})}startLiveValueInterval(){this.interval=setInterval(()=>{let e=this.getRenderProp(`value`);this.getState(`liveValue`)!==e&&this.setState(`liveValue`,e)},5e3)}},C=`/* forward the rem function */
/*
