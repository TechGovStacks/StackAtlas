import"./i18n-CoO4-0na-qoovQgD0.js";import"./component-names-Dy77vq43-y0h3WhLS.js";import{d as e,f as t,gt as n,ht as r,p as i}from"./index-Bzsf6a1p.js";import{n as a,t as o}from"./dev.utils-Bp48T7K--2qtfpOZi.js";import"./base-web-component-BT6jbe_v-DWHCzOf8.js";import{n as s,t as c}from"./tslib.es6-QNbPBOk5-D9aKojha.js";import{t as l}from"./clsx-COFh-Vc8-D7oNE5IG.js";import"./Heading-B1x6PKRk-DPL9s1fP.js";import"./disabled-BcXSZaDo-CTTGrcRG.js";import"./label-Ftw1VCQG-fN_SH8w2.js";import"./element-focus-BQXzaLL9-CnH-GzMZ.js";import{n as u,r as d,t as f}from"./element-interaction-C5-6aPzz-tu0zcLVv.js";import"./isArray-CcrBs4JM-C7XdtgJ2.js";import"./_Uint8Array-kJHDjtoP-Cgd-xGMS.js";import"./normalizers-Dmgd1cXp-D14ncJWd.js";import"./i18n-BsXYYo8j-pJ08HAmu.js";import"./component-C0fGqGE4-DwB2XYln.js";import"./Alert-B0-brpb4-wYBU6PF3.js";import"./label-RX8TPr4R-BpzALKBH.js";import"./variant-quote-BI3zVSZn-B8h_1DnW.js";import"./base-controller-CXhqh4cR-KCGhnJij.js";import"./component-D7UTo-Wg-DL_yqTwz.js";import"./icons-BX75HD_Y-uzkeEt0P.js";import"./access-and-short-key-Mj1AS76I-eY6q59PI.js";import"./hide-label-B9ipEhG8-6hnYY9pd.js";import"./align-DpNc6EKs-DZv6D4mZ.js";import"./tooltip-align-ChjYN8Pt-Cpmgbi3l.js";import"./variant-class-name-DFWOlDkF-C9X_Fx6i.js";import"./component-ta0hHoH--Bn7gBBvY.js";import"./align-floating-elements-BgsKEL5o-DUb2svXl.js";import"./controller-DV0N3zXZ-DqQFAXUL.js";import"./aria-labelledby-6-ki3akM-k8XdxMhb.js";import"./aria-details-8nY2-PPr-DcPar3Vq.js";import"./associated.controller-CKYHZabJ-C-qR_e8Y.js";import{a as p,c as m,o as h,s as g,t as _}from"./FormFieldStateWrapper-RFAVyAWM-DEcTn8ge.js";import{n as v,t as y}from"./controller-icon-E2i_Tvo6-DCZ5ffEL.js";import{t as b}from"./placeholder-BBA3H0w5-Cl3h3ylJ.js";import{t as x}from"./required-DSzN5_9V-CBbPqK4a.js";import{t as S}from"./read-only-CR_961Fh-CtOKAkOh.js";import{i as C,n as w,r as T,t as E}from"./counter-dom-updater-DbyoBkbs--mItXjLD.js";import{t as D}from"./spell-check-CoGXExpz-Q1uan0qh.js";import{t as O}from"./rows-BJbzOEWy-Ry280Zj5.js";var k=[`vertical`,`none`],A=e=>typeof e==`string`&&k.includes(e),j=(e,t)=>{n(e,`_resize`,A,new Set(k),t,{defaultValue:`vertical`})},M=e=>{let{class:n,msg:r,touched:i,readonly:a,disabled:o,required:c,ariaDescribedBy:u,hideLabel:d,label:f}=e,g=s(e,[`class`,`msg`,`touched`,`readonly`,`disabled`,`required`,`ariaDescribedBy`,`hideLabel`,`label`]),_={"kol-textarea--disabled":!!o,"kol-textarea--required":!!c,"kol-textarea--touched":!!i,"kol-textarea--readonly":!!a,[`kol-textarea--${h(r)}`]:m(r,i)},v=Object.assign(Object.assign({class:l(`kol-textarea`,_,n),required:c,disabled:o,readonly:a},p({ariaDescribedBy:u,hideLabel:d,label:f})),g);return t(`textarea`,Object.assign({},v))};function N(e,t){let n=g(e),r=[...n.ariaDescribedBy,...t.ariaDescribedBy??[]],i=Object.assign(Object.assign({id:e._id,hideLabel:e._hideLabel,label:e._label,value:e._value,accessKey:e._accessKey,disabled:e._disabled,name:e._name,rows:e._rows,readonly:e._readOnly,required:e._required,placeholder:e._placeholder,touched:e._touched,msg:e._msg},t),{ariaDescribedBy:r,"aria-invalid":n.hasError?`true`:void 0});return`_maxLength`in e&&`_maxLengthBehavior`in e&&e._maxLengthBehavior===`hard`&&(i.maxLength=e._maxLength),`_shortKey`in e&&(i[`aria-keyshortcuts`]=e._shortKey),i}var P=e=>{var{state:n}=e,r=s(e,[`state`]);return t(M,Object.assign({},N(n,r)))},F=class extends v{constructor(e,t,n){super(e,t,n),this.component=e}validateHasCounter(e){w(this.component,e)}validateMaxLengthBehavior(e){C(this.component,e)}validateMaxLength(e){T(this.component,e)}validatePlaceholder(e){b(this.component,e)}validateReadOnly(e){S(this.component,e)}validateResize(e){j(this.component,e)}validateRequired(e){x(this.component,e)}validateRows(e){O(this.component,e)}validateSpellCheck(e){D(this.component,e)}validateValue(e){r(this.component,`_value`,e),this.setFormAssociatedValue(this.component._value)}componentWillLoad(){super.componentWillLoad(),this.validateHasCounter(this.component._hasCounter),this.validateMaxLengthBehavior(this.component._maxLengthBehavior),this.validateMaxLength(this.component._maxLength),this.validatePlaceholder(this.component._placeholder),this.validateReadOnly(this.component._readOnly),this.validateRequired(this.component._required),this.validateResize(this.component._resize),this.validateRows(this.component._rows),this.validateSpellCheck(this.component._spellCheck),this.validateValue(this.component._value)}},I=`@charset "UTF-8";
/*
