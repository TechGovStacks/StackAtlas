import"./i18n-B2d_exHc-CgGRpl2S.js";import{f as e,l as t,p as n}from"./index-_jAleQV9.js";import"./isArray-CcrBs4JM-BA9_Jb9Z.js";import"./_Uint8Array-kJHDjtoP-BG0C2avY.js";import{a as r,n as i,o as a}from"./normalizers-C14RETgU-DSmIktDT.js";import{t as o}from"./variant-quote-DI6q8gPw-BCELA3OT.js";import{t as s}from"./label-DK7sT-k5-CMAIkf0n.js";import{t as c}from"./base-controller-CXhqh4cR-ht1hwgla.js";import{t as l}from"./i18n-BVaUp6qp-Dbq0-y_9.js";import{n as u,r as d,t as f}from"./value-number-clamped-_HbNn448-C-jCkupD.js";var p=i(`high`,0,r),m=i(`low`,0,r),h=i(`min`,0,r),g=i(`optimum`,0,r),_=[`horizontal`,`vertical`],v=i(`orientation`,`horizontal`,e=>{let t=a(e);if(_.includes(t))return t;throw Error(`Invalid orientation: ${t}`)}),y=i(`value`,0,r,e=>e>=0);function b(e,t,n,r,i,a){let o=r??t,s=i??n;if(a===void 0)return e>=o&&e<=s?`optimum`:`suboptimal`;let c=e<o,l=e>s,u=!c&&!l;return a<o?c?`optimum`:u?`suboptimal`:`critical`:a>s?l?`optimum`:u?`suboptimal`:`critical`:u?`optimum`:`suboptimal`}var x=t=>{let{high:n,label:r,low:i,liveValue:a,max:o,min:s,optimum:c,orientation:u,unit:d,value:f}=t,p=u===`vertical`,m=d===`%`,h=m?Math.round((f-s)/(o-s)*100):f,g=m?`${Math.round((a-s)/(o-s)*100)}`:a,_=`${`${(m?100:o)+1}`.length}ch`,v=Math.min(100,Math.max(0,(f-s)/(o-s)*100)),y=b(f,s,o,i,n,c),x=i!==void 0||n!==void 0,S=x?l(`kol-meter-state-${y}`):``,C=m?l(`kol-live-value`,{placeholders:{value:String(g),unit:d}}):l(`kol-live-value-bounded`,{placeholders:{value:String(g),max:String(o),unit:d}}),w=x?`${C} – ${S}`:C,T={"kol-meter__bar-fill":!0,"kol-meter__bar-fill--optimum":y===`optimum`,"kol-meter__bar-fill--suboptimal":y===`suboptimal`,"kol-meter__bar-fill--critical":y===`critical`};return e(`div`,{class:{"kol-meter":!0,"kol-meter--vertical":p}},e(`div`,{"aria-hidden":`true`,class:`kol-meter__bar`},e(`div`,{class:`kol-meter__bar-label`},r,x&&e(`span`,{class:`kol-meter__bar-state kol-meter__bar-state--${y}`},` – `,S)),p?e(`div`,{class:`kol-meter__bar-track`},e(`div`,{class:T,style:{height:`calc((100% - 6px) * ${v/100})`}})):e(`svg`,{xmlns:`http://www.w3.org/2000/svg`,width:`100%`,height:`12`,overflow:`visible`},e(`rect`,{class:`kol-meter__bar-background`,x:`1`,y:`1`,height:`11`,rx:`5`,fill:`currentColor`,stroke:`currentColor`,"stroke-width":`3`,width:`100%`}),e(`rect`,{class:`kol-meter__bar-border`,x:`1`,y:`1`,height:`11`,rx:`5`,fill:`currentColor`,stroke:`currentColor`,"stroke-width":`1`,width:`100%`}),e(`rect`,{class:T,x:`3`,y:`3`,height:`7`,rx:`3.5`,fill:`currentColor`,stroke:`currentColor`,"stroke-width":`3`,style:{width:`calc(${v}% - 4px)`}})),e(`span`,{class:`kol-meter__value-unit`},e(`span`,{class:`kol-meter__value`,style:p?{}:{width:_}},h),`\xA0`,e(`span`,{class:`kol-meter__unit`},d))),e(`meter`,{"aria-label":r,class:`visually-hidden`,high:n,low:i,max:o,min:s,optimum:c,value:f}),e(`span`,{"aria-live":`polite`,"aria-relevant":`additions text`,class:`visually-hidden`},w))},S={optional:[h,v,d],required:[s,u,y]},C=class extends c{constructor(e){super(e,S),this.meterData={high:void 0,low:void 0,optimum:void 0}}componentWillLoad(e){let{high:t,label:n,low:r,max:i,min:a,optimum:o,orientation:s,unit:c,value:l}=e;this.watchHigh(t),this.watchLabel(n),this.watchLow(r),this.watchMax(i),this.watchMin(a),this.watchOptimum(o),this.watchOrientation(s),this.watchUnit(c),this.watchValue(l),this.setState(`liveValue`,this.getRenderProp(`value`)),this.startLiveValueInterval()}destroy(){this.interval&&=(clearInterval(this.interval),void 0)}getMeterData(){return this.meterData}watchHigh(e){e===void 0?this.meterData.high=void 0:p.apply(e,e=>{this.meterData.high=e})}watchLabel(e){s.apply(e,e=>{this.setRenderProp(`label`,e)})}watchLow(e){e===void 0?this.meterData.low=void 0:m.apply(e,e=>{this.meterData.low=e})}watchMax(e){u.apply(e,e=>{this.setRenderProp(`max`,e),this.watchValue(this.getRawProp(`value`))})}watchMin(e){h.apply(e,e=>{this.setRenderProp(`min`,e),this.watchValue(this.getRawProp(`value`))})}watchOptimum(e){e===void 0?this.meterData.optimum=void 0:g.apply(e,e=>{this.meterData.optimum=e})}watchOrientation(e){v.apply(e,e=>{this.setRenderProp(`orientation`,e)})}watchUnit(e){d.apply(e,e=>{this.setRenderProp(`unit`,e)})}watchValue(e){this.setRawProp(`value`,e),f.apply(e,e=>{this.setRenderProp(`value`,e)},{min:this.getRenderProp(`min`),max:this.getRenderProp(`max`)})}startLiveValueInterval(){this.interval=setInterval(()=>{let e=this.getRenderProp(`value`);this.getState(`liveValue`)!==e&&this.setState(`liveValue`,e)},5e3)}},w=`/* forward the rem function */
/*
