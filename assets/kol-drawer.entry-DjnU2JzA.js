import{a as e}from"./component-names-Dy77vq43-y0h3WhLS.js";import{d as t,f as n,h as r,l as i,ot as a,p as o,v as s,y as c}from"./index-B3elEngz.js";import{t as l}from"./clsx-COFh-Vc8-BHwl83Bk.js";import{n as u}from"./align-D3Z54kEL-HAsowrtw.js";import{r as d}from"./label-vxVEH2gH-Djj6-FfT.js";import{t as f}from"./open-BMZVrISI-CMWNsuCo.js";import{t as p}from"./has-closer-CfUBQHmY-D73ssEC9.js";var m=`@charset "UTF-8";
/*
...
}`,h=class{constructor(e){o(this,e),this.getWrapperRef=e=>this.dialogWrapperElement=e,this.getRef=e=>{this.dialogElement=e,setTimeout(()=>{this.openOrCloseBasedOnState()})},this._hasCloser=!1,this.state={_label:``,_open:!1,_align:`left`}}async open(){var e;this.state=Object.assign(Object.assign({},this.state),{_open:!0}),(e=this.dialogElement)==null||e.showModal()}async close(){this.state=Object.assign(Object.assign({},this.state),{_open:!1});let e=this.dialogWrapperElement;e&&window.getComputedStyle(e).animationName===`none`&&this.handleCloseDialog()}renderDialogContent(){let t=this.state._align;return n(e,{ref:this.getWrapperRef,class:l(`kol-drawer__wrapper`,`kol-drawer__wrapper--${t}`,{"kol-drawer__wrapper--open":this.state._open,"kol-drawer__wrapper--is-closing":!1===this.state._open}),_label:this.state._label,_hasCloser:this.state._hasCloser,_on:{onClose:()=>{this.close()}}},n(`div`,{class:`kol-drawer__content`},n(`slot`,null)))}render(){return n(i,{key:`ecfa984c8b857de6070a7a812880d421842098b3`,class:`kol-drawer`},n(`dialog`,{key:`7c71d619787a68eadc7cd897013b593d7c6a43a3`,"aria-label":this.state._label,class:`kol-drawer__dialog`,onCancel:r,ref:this.getRef},this.renderDialogContent()))}validateLabel(e){d(this,e,{required:!0})}validateAlign(e){u(this,e)}validateHasCloser(e){p(this,e)}validateOpen(e){typeof e==`boolean`&&(f(this,e),this.dialogElement&&this.openOrCloseBasedOnState())}async openOrCloseBasedOnState(){this.state._open?await this.open():await this.close()}validateOn(e){if(typeof e==`object`&&e){let t={};typeof e.onClose==`function`&&(t.onClose=e.onClose),a(this,`_on`,t)}}handleCloseDialog(){var e,t,n;(e=this.dialogElement)==null||e.close(),(n=(t=this._on)?.onClose)==null||n.call(t),this.host&&c(this.host,s.close)}handleClose(){(async()=>{await this.close(),this.handleCloseDialog()})()}handleAnimationEnd(e){e.animationName.includes(`slideOut`)&&this.handleCloseDialog()}componentDidLoad(){var e,t;(e=this.dialogElement)==null||e.addEventListener(`animationend`,this.handleAnimationEnd.bind(this)),(t=this.dialogElement)==null||t.addEventListener(`close`,this.handleClose.bind(this))}disconnectedCallback(){var e,t;(e=this.dialogElement)==null||e.removeEventListener(`animationend`,this.handleAnimationEnd.bind(this)),(t=this.dialogElement)==null||t.removeEventListener(`close`,this.handleClose.bind(this))}componentWillLoad(){this.validateLabel(this._label),this.validateOpen(this._open),this.validateAlign(this._align),this.validateHasCloser(this._hasCloser),this.validateOn(this._on)}get host(){return t(this)}static get watchers(){return{_label:[`validateLabel`],_align:[`validateAlign`],_hasCloser:[`validateHasCloser`],_open:[`validateOpen`],_on:[`validateOn`]}}};h.style={default:m};export{h as kol_drawer};