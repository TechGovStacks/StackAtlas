import{c as e,o as t,s as n}from"./index-BQlHOxik-B62Ymb56.js";import{_ as r}from"./component-names-Dy77vq43-Bz1me821.js";import{n as i,t as a}from"./aria-labelledby-CEzR68x--x3SrWYra.js";var o=`@charset "UTF-8";
/*
...
}`,s=class{constructor(t){e(this,t),this.resolvedElements=[]}validateAriaLabelledby(e){this.syncExternalLabel(e)}syncExternalLabel(e){this.resolvedElements=i(this,this.host,this.internals,e)}componentWillLoad(){this.internals=a(this.host),this.syncExternalLabel(this._ariaLabelledby)}componentDidLoad(){this.resolvedElements.length||this.syncExternalLabel(this._ariaLabelledby)}render(){return n(r,{key:`7115f32bb9375fc5d4158bef05eded091fa77091`,externalLabelElements:this.resolvedElements,_data:this._data,_dataFoot:this._dataFoot,_fixedCols:this._fixedCols,_headerCells:this._headerCells,_label:this._label,_on:this._on,_selection:this._selection,_hasSettingsMenu:this._hasSettingsMenu,_variant:this._variant})}get host(){return t(this)}static get watchers(){return{_ariaLabelledby:[`validateAriaLabelledby`]}}};s.style={default:o};export{s as kol_table_stateless};