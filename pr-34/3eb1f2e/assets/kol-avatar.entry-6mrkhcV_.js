import{c as e,r as t,s as n}from"./index-B7tv7olz-DmEsWcmh.js";import"./i18n-B2d_exHc-B0S3j5ey.js";import{o as r}from"./index-BiYsVP7e.js";import"./isArray-CcrBs4JM-Bl_U_CM4.js";import"./_Uint8Array-kJHDjtoP-C7gl70Rp.js";import{n as i}from"./normalizers-DnkJhVYZ-cj5avhKj.js";import{t as a}from"./variant-quote-CHD0qMkY-C9dK2qSq.js";import{t as o}from"./label-BEOW9ltS-DID1B2MC.js";import{t as s}from"./base-controller-CXhqh4cR-DNOqRYhI.js";import{t as c}from"./i18n-BVaUp6qp-BL8KJsHH.js";import{t as l}from"./contrast-DK7TU5NR-z4gy0gbj.js";import{t as u}from"./src-D1LGDerl-D6pf3unI.js";var d=/^#((\d|[a-f]){8}|(\d|[a-f]){6}|(\d|[a-f]){3,4})$/i;function f(e){return d.test(e)}function p(e){if(typeof e==`string`&&f(e)){let t=l(e);return{backgroundColor:t.background,foregroundColor:t.foreground}}if(typeof e==`object`&&e){let t=e;if(typeof t.backgroundColor==`string`&&typeof t.foregroundColor==`string`&&f(t.backgroundColor)&&f(t.foregroundColor)){let e=l({background:t.backgroundColor,foreground:t.foregroundColor});return{backgroundColor:e.background,foregroundColor:e.foreground}}}throw Error(`Invalid color ${e}`)}function m(e){return f(e.foregroundColor)&&f(e.backgroundColor)}var h=i(`color`,{backgroundColor:`#d3d3d3`,foregroundColor:`#3f3f3f`},p,m),g=r(`kol-avatar`,`image`),_=r(`kol-avatar`,`initials`),v=e=>{let{color:t,initials:r,label:i,src:a}=e;return n(`div`,{"aria-label":c(`kol-avatar-alt`,{placeholders:{name:i}}),class:`kol-avatar`,role:`img`,style:{backgroundColor:t.backgroundColor,color:t.foregroundColor}},a?n(`img`,{alt:``,"aria-hidden":`true`,class:g,src:a}):n(`span`,{"aria-hidden":`true`,class:_},r))},y={optional:[h,u],required:[o]},b=e=>e.length===0?``:e[0].toUpperCase(),x=e=>{let t=e.trim().split(/\s+/),n=t[0],r=t[t.length-1];return t.length>=2&&n&&r?`${b(n)}${b(r)}`:b(e)},S=class extends s{constructor(e){super(e,y)}componentWillLoad(e){let{color:t,label:n,src:r}=e;this.watchColor(t),this.watchLabel(n),this.watchSrc(r)}watchColor(e){h.apply(e,e=>{this.setRenderProp(`color`,e)})}watchLabel(e){o.apply(e,e=>{this.setRenderProp(`label`,e),this.setState(`initials`,x(e))})}watchSrc(e){u.apply(e,e=>{this.setRenderProp(`src`,e)})}},C=`/* forward the rem function */
/*
