import"./i18n-CoO4-0na-qoovQgD0.js";import{c as e,r as t,s as n}from"./index-CJ6nR8sE-BVpuueRK.js";import{t as r}from"./base-web-component-BT6jbe_v-SPsPlDfK.js";import"./isArray-CcrBs4JM-WIW03eH5.js";import"./_Uint8Array-kJHDjtoP-B3BfDOx1.js";import{a as i,n as a,o}from"./normalizers-Dmgd1cXp-BAh6VGgH.js";import{t as s}from"./i18n-BsXYYo8j-Dscrx0oa.js";import{t as c}from"./label-RX8TPr4R-DTghETnR.js";import"./variant-quote-BI3zVSZn-CFOgvSz5.js";import{t as l}from"./base-controller-CXhqh4cR-DMPubRA9.js";import{n as u,r as d,t as f}from"./value-number-clamped-DlQghACX-BBtCBqvL.js";var p=a(`high`,0,i),m=a(`low`,0,i),h=a(`min`,0,i),g=a(`optimum`,0,i),_=[`horizontal`,`vertical`],v=a(`orientation`,`horizontal`,e=>{let t=o(e);if(_.includes(t))return t;throw Error(`Invalid orientation: ${t}`)}),y=a(`value`,0,i,e=>e>=0);function b(e,t,n,r,i,a){let o=r??t,s=i??n;if(a===void 0)return e>=o&&e<=s?`optimum`:`suboptimal`;let c=e<o,l=e>s,u=!c&&!l;return a<o?c?`optimum`:u?`suboptimal`:`critical`:a>s?l?`optimum`:u?`suboptimal`:`critical`:u?`optimum`:`suboptimal`}var x=e=>{let{high:t,label:r,low:i,max:a,min:o,optimum:c,orientation:l,unit:u,value:d}=e,f=l===`vertical`,p=u===`%`,m=p?Math.round((d-o)/(a-o)*100):d,h=b(d,o,a,i,t,c),g=i!==void 0||t!==void 0,_=g?s(`kol-meter-state-${h}`):``,v=p?s(`kol-live-value`,{placeholders:{value:String(m),unit:u}}):s(`kol-live-value-bounded`,{placeholders:{value:String(m),max:String(a),unit:u}}),y=g?`${v} – ${_}`:v,x=a.toString().length>o.toString().length?a.toString().length+`ch`:o.toString().length+`ch`;return n(`div`,{class:{"kol-meter":!0,"kol-meter--vertical":f}},n(`div`,{class:`kol-meter__bar`},n(`div`,{class:`kol-meter__bar-label`},r,g&&n(`span`,{class:`kol-meter__bar-state kol-meter__bar-state--${h}`},` – `,_)),n(`div`,{class:`kol-meter__bar-track`},n(`meter`,{"aria-label":r,"aria-valuetext":y,high:t,low:i,max:a,min:o,optimum:c,value:d})),n(`span`,{class:`kol-meter__value-unit`},n(`span`,{class:`kol-meter__value`,style:{"min-width":x}},m),n(`span`,{class:`kol-meter__unit`},u))))},S={optional:[h,v,d],required:[c,u,y]},C=class extends l{constructor(e){super(e,S),this.meterData={high:void 0,low:void 0,optimum:void 0}}componentWillLoad(e){let{high:t,label:n,low:r,max:i,min:a,optimum:o,orientation:s,unit:c,value:l}=e;this.watchHigh(t),this.watchLabel(n),this.watchLow(r),this.watchMax(i),this.watchMin(a),this.watchOptimum(o),this.watchOrientation(s),this.watchUnit(c),this.watchValue(l)}getMeterData(){return this.meterData}watchHigh(e){e===void 0?this.meterData.high=void 0:p.apply(e,e=>{this.meterData.high=e})}watchLabel(e){c.apply(e,e=>{this.setRenderProp(`label`,e)})}watchLow(e){e===void 0?this.meterData.low=void 0:m.apply(e,e=>{this.meterData.low=e})}watchMax(e){u.apply(e,e=>{this.setRenderProp(`max`,e),this.watchValue(this.getRawProp(`value`))})}watchMin(e){h.apply(e,e=>{this.setRenderProp(`min`,e),this.watchValue(this.getRawProp(`value`))})}watchOptimum(e){e===void 0?this.meterData.optimum=void 0:g.apply(e,e=>{this.meterData.optimum=e})}watchOrientation(e){v.apply(e,e=>{this.setRenderProp(`orientation`,e)})}watchUnit(e){d.apply(e,e=>{this.setRenderProp(`unit`,e)})}watchValue(e){this.setRawProp(`value`,e),f.apply(e,e=>{this.setRenderProp(`value`,e)},{min:this.getRenderProp(`min`),max:this.getRenderProp(`max`)})}},w=`@charset "UTF-8";
