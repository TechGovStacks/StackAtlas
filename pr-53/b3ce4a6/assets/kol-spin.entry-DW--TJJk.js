import"./i18n-B2d_exHc-Danqu8G9.js";import{c as e,n as t,r as n,s as r}from"./index-BQlHOxik-CjL7VUrP.js";import"./isArray-CcrBs4JM-Bl_U_CM4.js";import"./_Uint8Array-kJHDjtoP-B_wG6iDl.js";import{n as i,o as a,r as o}from"./normalizers-m3s9sgmq-DAp_Ovk5.js";import{t as s}from"./variant-quote-y0Z1TRdz-aXxOxSw7.js";import{t as c}from"./label-KTv-zMW0-jgXgb1As.js";import{t as l}from"./base-controller-CXhqh4cR-DNOqRYhI.js";import{t as u}from"./i18n-Br16IAnY-2K7vwmsl.js";var d=i(`show`,!1,o),f=[`dot`,`cycle`,`none`],p=i(`variant`,`dot`,e=>{let t=a(e);if(f.includes(t))return t;throw Error(`Invalid spin variant: ${t}`)},()=>!0);function m(e){switch(e){case`cycle`:return r(`span`,{class:`kol-spin__loader kol-spin__spinner--${e}__element`});case`none`:return r(`slot`,{name:`expert`});default:return r(t,null,r(`span`,{class:`kol-spin__spinner-element 
