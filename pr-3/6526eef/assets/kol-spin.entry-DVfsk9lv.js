import{c as e,n as t,r as n,s as r}from"./index-G8af0_gG-BpTwjaws.js";import"./i18n-B2d_exHc-B0S3j5ey.js";import"./isArray-CcrBs4JM-Bl_U_CM4.js";import"./_Uint8Array-kJHDjtoP-C7gl70Rp.js";import{n as i,o as a,r as o}from"./normalizers-DnkJhVYZ-Cr3EFjCS.js";import{t as s}from"./variant-quote-CHD0qMkY-ODpHkJl0.js";import{t as c}from"./label-BEOW9ltS-DhqPFfBi.js";import{t as l}from"./base-controller-CXhqh4cR-DNOqRYhI.js";import{t as u}from"./i18n-BVaUp6qp-AzRgzFgP.js";var d=i(`show`,!1,o),f=[`dot`,`cycle`,`none`],p=i(`variant`,`dot`,e=>{let t=a(e);if(f.includes(t))return t;throw Error(`Invalid spin variant: ${t}`)},()=>!0);function m(e){switch(e){case`cycle`:return r(`span`,{class:`kol-spin__loader`});case`none`:return r(`slot`,{name:`expert`});default:return r(t,null,r(`span`,{class:`kol-spin__spinner-element kol-spin__spinner-element--1`}),r(`span`,{class:`kol-spin__spinner-element kol-spin__spinner-element--2`}),r(`span`,{class:`kol-spin__spinner-element kol-spin__spinner-element--3`}),r(`span`,{class:`kol-spin__spinner-element kol-spin__spinner-element--neutral`}))}}var h=e=>{let{show:n,label:i,variant:a,showToggled:o,handleGetTranslateActionRunning:s,handleGetTranslateActionDone:c}=e;return r(t,null,n?r(t,null,r(`span`,{class:`kol-spin__spinner kol-spin__spinner--${a}`},m(a)),r(`span`,{"aria-busy":`true`,class:`visually-hidden`,role:`alert`},i||s())):o&&r(`span`,{"aria-busy":`false`,class:`visually-hidden`,role:`alert`},i||c()))},g={optional:[c,d,p]},_=class extends l{constructor(e){super(e,g),this.translateActionRunning=u(`kol-action-running`),this.translateActionDone=u(`kol-action-done`),this.handleGetTranslateActionRunning=()=>this.translateActionRunning,this.handleGetTranslateActionDone=()=>this.translateActionDone}componentWillLoad(e){let{show:t,label:n,variant:r}=e;this.watchShow(t),this.watchLabel(n),this.watchVariant(r)}watchShow(e){d.apply(e,e=>{let t=this.getRenderProp(`show`);this.setRenderProp(`show`,e),this.setState(`showToggled`,!0===t&&!1===e)})}watchLabel(e){c.apply(e,e=>{this.setRenderProp(`label`,e)})}watchVariant(e){p.apply(e,e=>{this.setRenderProp(`variant`,e)})}},v=`/* forward the rem function */
/*
