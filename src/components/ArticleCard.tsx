								...
								<div>
									...
									<div className="drawer-links">
										{selectedArticle.homepage && (
											<KolLinkButton _label={t('article.website')} _href={selectedArticle.homepage} _variant="secondary" className="drawer-link" />
										)}
										{selectedArticle.github?.repo && (
											<KolLinkButton _label={t('article.repository')} _href={selectedArticle.github.repo} _variant="secondary" className="drawer-link" />
										)}
										...
										<div className="score-breakdown">
											...
											<div className="score-breakdown__rows">
												<div className="score-breakdown__row">
													...
													<span className="score-breakdown__info">
