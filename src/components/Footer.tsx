		...
		<footer className="footer w-full border-t mt-auto">
			<div className="footer__inner flex flex-col max-w-6xl mx-auto px-4 md:px-6 w-full">
				<div className="footer__nav flex flex-col items-start gap-6 py-8 md:py-12 border-b">
					<div className="footer__brand-row flex flex-col md:flex-row md:items-start md:justify-between w-full gap-4">
						...
						<a href={GITHUB_REPO} rel="noopener noreferrer" className="footer__github-corner" aria-label={t('footer.links.githubCta')}>
							{t('footer.links.githubCta')}
						</a>
					</div>
					...
					<nav className="footer__nav-section flex flex-wrap gap-4 md:gap-6 text-sm" aria-label={t('footer.navigationAria')}>
						...
						<a href={GITHUB_REPO} rel="noopener noreferrer" className="footer__link">
							GitHub
						</a>
