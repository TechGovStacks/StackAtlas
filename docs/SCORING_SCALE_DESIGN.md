...
Für ganzzahlige Scores gelten die dokumentierten Bereichsgrenzen. Dezimale
Durchschnittswerte aus Stack-Berechnungen werden lückenlos anhand der oberen
Grenzen zugeordnet: Werte >30 bis 45 sind `minimal`, >45 bis 60 `adequate`,
oberhalb von 60 bis 75 `good`, >75 bis 90 `excellent` und >90 bis 100
`outstanding`.
...
Stack-Durchschnittswerte können Dezimalstellen haben. Die Kategoriezuordnung
ist deshalb kontinuierlich: ein Wert wie 90,1 fällt nicht auf
`insufficient` zurück, sondern liegt in der nächsten Stufe `outstanding`.
